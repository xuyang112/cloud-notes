...
function EditForm({ initial }: { initial: Note }) {
  ...
  useEffect(() => {
    ...
    if (uploading) { window.alert('文件仍在上传，请稍后再离开。'); blocker.reset(); return }
    void flush().then(ok => {
